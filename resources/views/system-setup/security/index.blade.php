						...
						<div class="m-portlet">
									...
									<div class="m-portlet__body">
										<ul class="nav nav-pills nav-fill" role="tablist">
											<li class="nav-item">
												<a class="nav-link active" data-toggle="tab" href="#m_tabs_5_1">Feature Options</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#m_tabs_5_2">ACL</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#m_tabs_5_3">Roles</a>
                                            </li>
                                            <li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#m_tabs_5_2">User Groups</a>
                                            </li>
                                            <li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#m_tabs_5_1">Permissions</a>
											</li>
