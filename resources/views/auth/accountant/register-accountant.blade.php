...
<div class="container">
            ...
            <div class="form-group">
                <div class="col-md-4 col-md-offset-4">
                    <form action="{{ route('accountant.logout') }}" method="POST">
                        {{ csrf_field() }}
                        <button type="button" class="btn col-md-12 yellow-gradient" onclick="window.location='{{route('accountant.login')}}'">
                            <strong>Login</strong>
                        </button>
                    </form>
                </div>
    ...
    @else
        <div class="row">
            <form class="form-horizontal" method="POST" action="{{ route('register-accountant') }}">
                {{ csrf_field() }}

                <div class="form-group">
                    <div class="col-md-12 text-center text-white" style="margin: 0 auto; float: unset;">
                        <h3><strong>Create a new Accountant account</strong></h3>
                    </div>
                </div>

                <div class="form-group{{ $errors->has('company_name') ? ' has-error' : '' }}">
                    <label for="company_name" class="col-md-4 control-label text-white">Company Name</label>

                    <div class="col-md-4 text-center" style="margin: 0 auto; float: unset;">
                        <input id="company_name" type="text" class="form-control" name="company_name" value="{{ old('company_name') }}" required style="margin: 0 auto; float: unset;">
