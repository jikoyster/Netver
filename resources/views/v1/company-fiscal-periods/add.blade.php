	...
	<div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('company-fiscal-period.save') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('fiscal_year') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <select class="form-control" id="fiscal_year" name="fiscal_year">
                        ...
                        <option {{old('fiscal_year') == '2018' ? 'selected':''}}>2018</option>
                        <option {{old('fiscal_year') == '2019' ? 'selected':''}}>2019</option>
                    </select>
            ...
            <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="end_date" name="end_date" style="margin: 0 auto; float: unset;" value="{{old('end_date')}}">
            ...
            <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="start_date" name="start_date" style="margin: 0 auto; float: unset;" value="{{old('start_date')}}">
