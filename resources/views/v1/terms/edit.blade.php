...
<div class="container">
	<div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('term.edit',[Request::segment(3)]) }}">
            {{ csrf_field() }}

            <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12 text-center text-white" style="margin: 0 auto; float: unset;">
                    <h3><strong>Edit Term</strong></h3>
                </div>
            </div>
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-7 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="name" name="name" style="margin: 0 auto; float: unset;" value="{{old('name',$term->name)}}">
            ...
            <div class="form-group{{ $errors->has('standard_data_driven') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <label class="container-check pull-left">
                      <input type="radio" class="form-control pull-left" id="standard_data_driven" name="standard_data_driven" value="0" {{old('standard_data_driven',$term->standard) == 1 ? 'checked':''}} style="margin: 7px 7px 0 auto; width: 20px; height: 20px;">
                ...
                <div class="col-xs-1 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <label class="container-check pull-right">
                      <input type="radio" class="form-control pull-right" id="standard_data_driven" name="standard_data_driven" value="1" {{old('standard_data_driven',$term->data_driven) == 1 ? 'checked':''}} style="margin: 7px auto 0; width: 20px; height: 20px;">
                      <span class="checkmark"></span>
                    </label>
                </div>
            ...
            <div class="form-group{{ $errors->has('net_due1') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-2 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control pull-left" id="net_due1" name="net_due1" value="{{old('net_due1',$term->net_due)}}">
                ...
                <div class="col-xs-2 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control pull-left" id="net_due2" name="net_due2" value="{{old('net_due2',$term->net_due)}}">
            ...
            <div class="form-group{{ $errors->has('discount1') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-2 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control pull-left" id="discount1" name="discount1" value="{{old('discount1',$term->discount)}}">
                ...
                <div class="col-xs-2 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control pull-left" id="discount2" name="discount2" value="{{old('discount2',$term->discount)}}">
            ...
            <div class="form-group{{ $errors->has('discount_if_paid1') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-2 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control pull-left" id="discount_if_paid1" name="discount_if_paid1" value="{{old('discount_if_paid1',$term->discount_if_paid)}}">
                ...
                <div class="col-xs-2 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control pull-left" id="discount_if_paid2" name="discount_if_paid2" value="{{old('discount_if_paid2',$term->discount_if_paid)}}">
            ...
            <div class="form-group{{ $errors->has('inactive') ? ' has-error' : '' }}">
                <div class="col-xs-offset-7 col-xs-3 text-center">
                    ...
                    <label class="container-check pull-right">
                      <input type="checkbox" class="form-control pull-right" id="inactive" name="inactive" {{old('inactive',$term->inactive) ? 'checked':''}} style="margin: 7px auto 0; width: 20px; height: 20px;">
                      <span class="checkmark"></span>
                    </label>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 text-center" style="margin: 0 auto; float: unset;">
                    <button type="button" onclick="window.location='{{route('terms')}}'" class="btn yellow-gradient" style="margin: 0 7px; float: unset;">
                        <strong>Back</strong>
                    </button>
