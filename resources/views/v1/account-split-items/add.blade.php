	...
	<div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('account-split-item.save') }}">
            {{ csrf_field() }}
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <select class="form-control" id="account_no" name="account_no">
                        ...
                        @foreach($chart_of_accounts as $account)
                            <option value="{{$account->id}}" {{old('account_no') == $account->id ? 'selected':''}}>{{$account->account_no.' - '.$account->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group{{ $errors->has('sub_account_no') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="sub_account_no" name="sub_account_no" style="margin: 0 auto; float: unset;" value="{{old('sub_account_no')}}">
            ...
            <div class="form-group{{ $errors->has('sub_account_name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="sub_account_name" name="sub_account_name" style="margin: 0 auto; float: unset;" value="{{old('sub_account_name')}}">
