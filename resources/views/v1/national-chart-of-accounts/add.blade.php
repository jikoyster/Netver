	...
	<div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('national-chart-of-account.save') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('short_name') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-2 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="short_name" name="short_name" style="margin: 0 auto; float: unset;" value="{{old('short_name')}}">
