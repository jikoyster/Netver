...
<div class="container">
    <div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('map-group-list.save',[Request::segment(3)]) }}">
            {{ csrf_field() }}

            <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12 text-center text-white" style="margin: 0 auto; float: unset;">
                    <h3><strong>Add Map Group List</strong></h3>
                </div>
            </div>
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-2 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="name" name="name" style="margin: 0 auto; float: unset;" value="{{old('name',$map_group->name)}}" readonly>
            ...
            <div class="form-group{{ $errors->has('group_source') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-2 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <select class="form-control" id="group_source" name="group_source">
                        <option value="">-select-</option>
                        <option value="account_maps">Account Map</option>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#grid-keep-selection").bootgrid({
            ...
            url: "<?=route('map-group-list.group-source',[Request::segment(3)])?>",
            selection: true,
            multiSelect: true,
            rowSelect: true,
            keepSelection: true,
