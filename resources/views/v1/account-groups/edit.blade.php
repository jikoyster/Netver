...
<div class="container">
	<div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('account-group.edit',[Request::segment(3)]) }}">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-1 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="code" name="code" style="margin: 0 auto; float: unset;" value="{{old('code',$account_group->code)}}">
                </div>
                @if ($errors->has('code'))
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="name" name="name" style="margin: 0 auto; float: unset;" value="{{old('name',$account_group->name)}}">
                ...
                <div class="col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <select class="form-control" id="parent_id" name="parent_id">
                        ...
                        @foreach($parent_groups as $group)
                            @if($group->id == old('parent_id',$account_group->parent_id))
            ...
            <div class="form-group{{ $errors->has('has_children') ? ' has-error' : '' }}">
                <div class="col-xs-offset-5 col-xs-3 text-center">
                    ...
                    <input type="checkbox" class="form-control pull-right" id="has_children" name="has_children" {{old('has_children',$account_group->has_children) ? 'checked':''}} style="margin: 7px auto 0; width: 20px; height: 20px;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 text-center" style="margin: 0 auto; float: unset;">
                    ...
                    <button type="button" onclick="window.location='{{route('account-groups')}}'" class="btn yellow-gradient pull-right" style="margin: 0 7px; float: unset;">
                        <strong>Back</strong>
                    </button>
                </div>
            </div>
