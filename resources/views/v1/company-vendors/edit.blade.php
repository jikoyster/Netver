...
<div class="col-md-12">
	...
	<div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('company-vendor.edit',[Request::segment(3)]) }}">
            {{ csrf_field() }}

            <div class="form-group">
                <div class="col-md-12 text-center text-white" style="margin: 0 auto; float: unset;">
                    <h3><strong>Edit Vendor</strong></h3>
                </div>
            </div>
            ...
            <div class="col-md-1 form-group{{ $errors->has('title') ? ' has-error' : '' }}" style="margin: 0;">
                <div style="width: 50%; float: right;">
                    ...
                    <div class="col-md-12 text-center" style="padding: 0; float: unset;">
                        <input type="text" class="form-control" id="title" name="title" style="margin: 0 auto; float: unset; padding: 7px;" value="{{old('title',$company_vendor->title)}}">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-2 form-group{{ $errors->has('first_name') ? ' has-error' : '' }}" style="margin: 0;">
                ...
                <div class="col-md-12 text-center" style="padding: 0; float: unset;">
                    <input type="text" class="form-control" id="first_name" name="first_name" style="margin: 0 auto; float: unset;" value="{{old('first_name',$company_vendor->first_name)}}">
                </div>
            </div>
            ...
            <div class="col-md-2 form-group{{ $errors->has('middle_name') ? ' has-error' : '' }}" style="margin: 0;">
                ...
                <div class="col-md-12 text-center" style="padding: 0; float: unset;">
                    <input type="text" class="form-control" id="middle_name" name="middle_name" style="margin: 0 auto; float: unset;" value="{{old('middle_name',$company_vendor->middle_name)}}">
                </div>
            </div>
            ...
            <div class="col-md-2 form-group{{ $errors->has('last_name') ? ' has-error' : '' }}" style="margin: 0;">
                ...
                <div class="col-md-12 text-center" style="padding: 0; float: unset;">
                    <input type="text" class="form-control" id="last_name" name="last_name" style="margin: 0 auto; float: unset;" value="{{old('last_name',$company_vendor->last_name)}}">
                </div>
            </div>
            ...
            <div class="col-md-1 form-group{{ $errors->has('suffix') ? ' has-error' : '' }}" style="margin: 0;">
                <div style="width: 50%;">
                    ...
                    <div class="col-md-12 text-center" style="padding: 0; float: unset;">
                        <input type="text" class="form-control" id="suffix" name="suffix" style="margin: 0 auto; float: unset; padding: 7px;" value="{{old('suffix',$company_vendor->suffix)}}">
                    </div>
                </div>
            </div>
            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="col-md-4 pull-right form-control" id="phone" name="phone" style="margin: 0 auto; width: inherit; float: unset;" value="{{old('phone',$company_vendor->phone)}}">
            ...
            <div class="col-md-8 form-group{{ $errors->has('company') ? ' has-error' : '' }}">
                ...
                <div class="col-md-7 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="company" name="company" style="margin: 0 auto; float: unset;" value="{{old('company',$company_vendor->company)}}">
                </div>
            </div>
            <div class="form-group{{ $errors->has('fax') ? ' has-error' : '' }}">
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="col-md-4 pull-right form-control" id="fax" name="fax" style="margin: 0 auto; width: inherit; float: unset;" value="{{old('fax',$company_vendor->fax)}}">
            ...
            <div class="col-md-8 form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <div class="col-md-7 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="email" name="email" style="margin: 0 auto; float: unset;" value="{{old('email',$company_vendor->email)}}">
                </div>
            </div>
            <div class="form-group{{ $errors->has('account_no') ? ' has-error' : '' }}">
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="col-md-4 pull-right form-control" id="account_no" name="account_no" style="margin: 0 auto; width: inherit; float: unset;" value="{{old('account_no',$company_vendor->account_no)}}">
            ...
            <div class="col-md-8 form-group{{ $errors->has('display_name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-7 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="display_name" name="display_name" style="margin: 0 auto; float: unset;" value="{{old('display_name',$company_vendor->display_name)}}">
                </div>
            </div>
                ...
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto; float: unset;">
                    <select type="text" class="col-md-4 pull-right form-control" id="currency" name="currency" style="margin: 0 auto; width: inherit; float: unset;">
                        ...
                        @foreach($global_currency->unique('currency')->sortBy('currency') as $code)
                            @if($company_vendor->parent_company->multi_currency)
                                <option value="{{$code->id}}" {{old('currency',$company_vendor->currency) == $code->id ? 'selected':''}}>{{$code->currency}}</option>
                            @else
                                @if($company_vendor->parent_company->country_currency && $company_vendor->parent_company->country_currency->currency_code == $code->alphabetic_code)
            ...
            <div class="col-md-8 form-group{{ $errors->has('use_display_name') ? ' has-error' : '' }}">
                <div class="col-md-offset-2 col-md-7 text-center">
                    ...
                    <label class="container-check pull-right">
                      <input type="checkbox" class="form-control pull-right" id="use_display_name" name="use_display_name" {{old('use_display_name',$company_vendor->use_display_name) ? 'checked':''}} style="margin: 7px auto 0; width: 20px; height: 20px;">
            ...
            <div class="form-group{{ $errors->has('billing_rate') ? ' has-error' : '' }}">
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="col-md-4 pull-right form-control" id="billing_rate" name="billing_rate" style="margin: 0 auto; width: inherit; float: unset;" value="{{old('billing_rate',$company_vendor->billing_rate)}}">
            ...
            <div class="col-md-8 form-group{{ $errors->has('print_cheque_as') ? ' has-error' : '' }}">
                <div class="col-md-offset-2 col-md-7 pull-left text-center">
                    <input type="text" class="form-control" id="print_cheque_as" name="print_cheque_as" style="margin: 0 auto; float: unset;" value="{{old('print_cheque_as',$company_vendor->print_cheque_as)}}">
                </div>
            </div>
            <div class="form-group{{ $errors->has('tax_id') ? ' has-error' : '' }}">
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="col-md-4 pull-right form-control" id="tax_id" name="tax_id" style="margin: 0 auto; width: inherit; float: unset;" value="{{old('tax_id',$company_vendor->tax_id)}}">
            ...
            <div class="col-md-8 form-group{{ $errors->has('website') ? ' has-error' : '' }}">
                ...
                <div class="col-md-7 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="website" name="website" style="margin: 0 auto; float: unset;" value="{{old('website',$company_vendor->website)}}">
                </div>
            </div>
                ...
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto; float: unset;">
                    ...
                    <select type="text" class="col-md-4 pull-left form-control" id="registration_type" name="registration_type" style="margin: 0 auto; width: 58%; float: unset;">
                        ...
                        @foreach($registration_types as $type)
                            <option value="{{$type->id}}" {{old('registration_type',$company_vendor->registration_type) == $type->id ? 'selected':''}}>{{$type->name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-8 form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                <div class="col-md-offset-2 col-md-7 pull-left text-center">
                    <textarea type="text" class="form-control" id="description" name="description" style="margin: 0 auto; float: unset; height: 100px;">{{old('description',$company_vendor->description)}}</textarea>
                </div>
            </div>
                ...
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto 20px auto; float: unset;">
                    ...
                    <select type="text" class="col-md-4 pull-left form-control" id="term" name="term" style="margin: 0 auto; width: 58%; float: unset;">
                        ...
                        @foreach($terms as $term)
                            <option value="{{$term->id}}" {{old('term',$company_vendor->term) == $term->id ? 'selected':''}}>{{$term->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto; float: unset;">
                    ...
                    <select type="text" class="col-md-4 pull-left form-control" id="trade" name="trade" style="margin: 0 auto; width: 58%; float: unset;">
                        ...
                        @foreach($trades as $trade)
                            <option value="{{$trade->id}}" {{old('trade',$company_vendor->trade) == $trade->id ? 'selected':''}}>{{$trade->name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-8 form-group{{ $errors->has('subcontractor') ? ' has-error' : '' }}">
                ...
                <div class="col-md-3 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <select type="text" class="form-control" id="subcontractor" name="subcontractor">
                        <option value="">select</option>
                        <option {{old('subcontractor',$company_vendor->subcontractor) == 'Yes' ? 'selected':''}}>Yes</option>
                        <option {{old('subcontractor',$company_vendor->subcontractor) == 'No' ? 'selected':''}}>No</option>
                    </select>
                </div>
            </div>
            <div class="form-group{{ $errors->has('credit_limit') ? ' has-error' : '' }}">
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto; float: unset;">
                    ...
                    <input type="text" class="col-md-4 pull-left form-control" id="credit_limit" name="credit_limit" style="margin: 0 auto; width: inherit; float: unset;" value="{{old('credit_limit',$company_vendor->credit_limit)}}">
                </div>
            </div>
            <div class="clearfix"></div>
                ...
                <div class="col-md-4 pull-right text-center" style="margin: 0 auto; float: unset;">
                    ...
                    <select class="col-md-4 pull-left form-control" id="status" name="status" style="margin: 0 auto; width: 58%; float: unset;">
                        ...
                        @foreach(['Active','Suspended','Closed'] as $status)
                            <option {{old('status',$company_vendor->status) == $status ? 'selected':''}}>{{$status}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-md-8 form-group{{ $errors->has('track_payment_t4a') ? ' has-error' : '' }}">
                <div class="col-md-offset-2 col-md-8 text-center">
                    <label class="container-check pull-left">
                      <input type="checkbox" class="form-control pull-right" id="track_payment_t4a" name="track_payment_t4a" {{old('track_payment_t4a',$company_vendor->track_payment_t4a) ? 'checked':''}} style="margin: 7px auto 0; width: 20px; height: 20px;">
                      <span class="checkmark"></span>
                    </label>
            ...
            <div class="col-md-8 form-group{{ $errors->has('track_payment_5018') ? ' has-error' : '' }}">
                <div class="col-md-offset-2 col-md-8 text-center">
                    <label class="container-check pull-left">
                      <input type="checkbox" class="form-control pull-right" id="track_payment_5018" name="track_payment_5018" {{old('track_payment_5018',$company_vendor->track_payment_5018) ? 'checked':''}} style="margin: 7px auto 0; width: 20px; height: 20px;">
                      <span class="checkmark"></span>
                    </label>
            ...
            <div class="col-md-8 form-group{{ $errors->has('track_payment_1099') ? ' has-error' : '' }}">
                <div class="col-md-offset-2 col-md-8 text-center">
                    <label class="container-check pull-left">
                      <input type="checkbox" class="form-control pull-right" id="track_payment_1099" name="track_payment_1099" {{old('track_payment_1099',$company_vendor->track_payment_1099) ? 'checked':''}} style="margin: 7px auto 0; width: 20px; height: 20px;">
                      <span class="checkmark"></span>
                    </label>
            ...
            <div class="col-md-8 form-group{{ $errors->has('vendor_is_tax_agency') ? ' has-error' : '' }}">
                <div class="col-md-offset-2 col-md-8 text-center">
                    <label class="container-check pull-left">
                      <input type="checkbox" class="form-control pull-right" id="vendor_is_tax_agency" name="vendor_is_tax_agency" {{old('vendor_is_tax_agency',$company_vendor->vendor_is_tax_agency) ? 'checked':''}} style="margin: 7px auto 0; width: 20px; height: 20px;">
                      <span class="checkmark"></span>
                    </label>
    ...
    $(function(){
        ...
        $('[name=subcontractor]').change(function(){
            if($(this).val() == 'Yes') {
                @if($country)
                    @if($country->id == 2)
                        $('[name=track_payment_t4a]').prop('checked','<?=$company_vendor->track_payment_t4a ? true:false?>').parent().parent().parent().show();
                        $('[name=track_payment_5018]').prop('checked','<?=$company_vendor->track_payment_5018 ? true:false?>').parent().parent().parent().show();
                        $('[name=track_payment_1099]').val(0).parent().parent().parent().hide();
                    @elseif($country->id == 4)
                        $('[name=track_payment_t4a],[name=track_payment_5018]').val(0).parent().parent().parent().hide();
                        $('[name=track_payment_1099]').prop('checked','<?=$company_vendor->track_payment_1099 ? true:false?>').parent().parent().parent().show();
                    @endif
                @endif
            } else {
