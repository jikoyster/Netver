...
<div class="container">
	<div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('menu.edit',[Request::segment(3)]) }}">
            ...
            <div class="form-group{{ $errors->has('has_parent') ? ' has-error' : '' }}" style="visibility: hidden;">
            ...
            <div class="link-container form-group{{ $errors->has('link') ? ' has-error' : '' }}" style="display: {{old('link',$menu->link) ? 'block':'none'}}; visibility: hidden;">
