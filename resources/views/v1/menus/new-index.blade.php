    ...
    $(function(){
        $("#grid-basic").bootgrid({
            ...
            formatters: {
                ...
                {
                    return "<a class=\"btn btn-xs command-view\" href=\"/menus/menu-elements/" + row.id + "\" data-toggle=\"tooltip\" title=\"Menu Elements\"><span class=\"glyphicon glyphicon-eye-open\"></span></a> "+"<a class=\"btn btn-xs btn-primary command-edit\" href=\"/menus/edit/" + row.id + "\" data-toggle=\"tooltip\" title=\"Edit\"><span class=\"glyphicon glyphicon-edit\"></span></a> "+"<button class=\"btn btn-xs btn-danger command-delete\" onclick=\"confirmModal(this)\" data-toggle=\"modal\" data-target=\".bs-example-modal-sm"+row.id+"\" data-toggle=\"tooltip\" title=\"Delete\" data-placement=\"right\"><span class=\"glyphicon glyphicon-trash\"></span></button>";
                }
            }
        });
        ...
        $('[name="group"]').change(function(){
            $.ajax({
              url: '/api/menus/data/'+$(this).val(),
              beforeSend: function(xhr){xhr.setRequestHeader('Authorization', 'Bearer '+JSON.parse(localStorage.getItem('currentUser')).access_token)},
            }).done(function(data){
