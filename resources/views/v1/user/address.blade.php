...
<div class="container">
	<div class="row">
        ...
        @endif
        <form class="form-horizontal" method="POST" action="{{ route('user.address') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 text-center" style="margin: 0 auto; float: unset;">
                    ...
                    <button type="button" onclick="history.back()" class="btn yellow-gradient pull-right" style="margin: 0 7px; float: unset;">
                        <strong>Back</strong>
                    </button>
                </div>
            </div>
