...
<div class="container">
	<div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('ui-registration.edit',[Request::segment(3)]) }}">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="name" name="name" style="margin: 0 auto; float: unset;" value="{{old('name',$ui->name)}}" readonly>
            ...
            <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="url" name="url" style="margin: 0 auto; float: unset;" value="{{old('url',$ui->url)}}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 text-center" style="margin: 0 auto; float: unset;">
                    ...
                    <button type="button" onclick="window.location='{{route('ui-registrations')}}'" class="btn yellow-gradient pull-right" style="margin: 0 7px; float: unset;">
                        <strong>Back</strong>
                    </button>
                </div>
            </div>
