...
<div class="container">
	<div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('ui-report.edit',[Request::segment(3)]) }}">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('issue') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <textarea type="text" class="form-control" id="issue" name="issue" style="margin: 0 auto; float: unset;" readonly>{{old('issue',$ui_report->issue)}}</textarea>
            ...
            <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="url" name="url" style="margin: 0 auto; float: unset;" value="{{old('url',$ui_report->url)}}" readonly>
            ...
            <div class="form-group{{ $errors->has('priority') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <select class="form-control" id="priority" name="priority">
                        <option value="1" {{old('priority',$ui_report->priority) == '1' ? 'selected':''}}>High</option>
                        <option value="2" {{old('priority',$ui_report->priority) == '2' ? 'selected':''}}>Medium</option>
                        <option value="3" {{old('priority',$ui_report->priority) == '3' ? 'selected':''}}>Low</option>
                    </select>
            ...
            <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <select class="form-control" id="status" name="status">
                        <option {{old('status',$ui_report->status) == 'Outstanding' ? 'selected':''}}>Outstanding</option>
                        <option {{old('status',$ui_report->status) == 'Resolved' ? 'selected':''}}>Resolved</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 text-center" style="margin: 0 auto; float: unset;">
                    ...
                    <button type="button" onclick="window.location='{{route('ui-reports')}}'" class="btn yellow-gradient pull-right" style="margin: 0 7px; float: unset;">
                        <strong>Back</strong>
                    </button>
                </div>
            </div>
