...
@role('super admin')
            <div class="form-group{{ $errors->has('is_system_role') ? ' has-error' : '' }}">
                <div class="col-xs-3 col-xs-offset-5 text-center">
                    ...
                    <input type="checkbox" class="form-control pull-right" id="is_system_role" name="is_system_role" {{old('is_system_role') ? 'checked':''}} style="margin: 7px auto 0; width: 20px; height: 20px;">
