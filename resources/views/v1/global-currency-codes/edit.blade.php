...
<div class="container">
	<div class="row" style="margin-bottom: 30px;">
        <form class="form-horizontal" method="POST" action="{{ route('global-currency-code.edit',[Request::segment(3)]) }}">
            {{ csrf_field() }}

            <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12 text-center text-white" style="margin: 0 auto; float: unset;">
                    <h3><strong>Edit Global Currency Code</strong></h3>
                </div>
            </div>
            ...
            <div class="form-group{{ $errors->has('entity') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="entity" name="entity" style="margin: 0 auto; float: unset;" value="{{old('entity',$global_currency_code->entity)}}">
                </div>
            ...
            <div class="form-group{{ $errors->has('currency') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input type="text" class="form-control" id="currency" name="currency" style="margin: 0 auto; float: unset;" value="{{old('currency',$global_currency_code->currency)}}">
            ...
            <div class="form-group{{ $errors->has('alphabetic_code') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input class="form-control" id="alphabetic_code" name="alphabetic_code" value="{{old('alphabetic_code',$global_currency_code->alphabetic_code)}}">
            ...
            <div class="form-group{{ $errors->has('numeric_code') ? ' has-error' : '' }}">
                ...
                <div class="col-xs-4 pull-left text-center" style="margin: 0 auto; float: unset;">
                    <input class="form-control" id="numeric_code" name="numeric_code" value="{{old('numeric_code',$global_currency_code->numeric_code)}}">
            ...
            <div class="form-group{{ $errors->has('active') ? ' has-error' : '' }}">
                <div class="col-xs-offset-5 col-xs-3 text-center">
                    ...
                    <label class="container-check pull-right">
                      <input type="checkbox" class="form-control pull-right" id="active" name="active" {{old('active',$global_currency_code->active) ? 'checked':''}} style="margin: 7px auto 0; width: 20px; height: 20px;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 text-center" style="margin: 0 auto; float: unset;">
                    ...
                    <button type="button" onclick="window.location='{{route('global-currency-codes')}}'" class="btn yellow-gradient pull-right" style="margin: 0 7px; float: unset;">
                        <strong>Back</strong>
                    </button>
                </div>
            </div>
