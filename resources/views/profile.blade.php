						...
						<div class="m-card-profile">
							...
							<div class="m-card-profile__details">
								<span class="m-card-profile__name">
									<!-- Mark Andre -->
									{!! $loggedin_user->fullname !!}
								</span>
								<a href="" class="m-card-profile__email m-link">{!! $loggedin_user->email !!}</a>
							</div>
						</div>
							...
							<form class="m-form m-form--fit m-form--label-align-right">
								<div class="m-portlet__body">
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-7">
											<input class="form-control m-input" value="{!! $loggedin_user->fullname !!}" type="text">
										</div>
									</div>
									<div class="form-group m-form__group row">
										<label for="example-text-input" class="col-2 col-form-label">Email</label>
										<div class="col-7">
											<input class="form-control m-input" value="{!! $loggedin_user->email !!}" type="text">
										</div>
									</div>
									<div class="form-group m-form__group row">
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-7">
											...
											<span class="m-form__help">If you want your invoices addressed to a company. Leave blank to use your full
												name.</span>
										</div>
									</div>
									<div class="form-group m-form__group row">
