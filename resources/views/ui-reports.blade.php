				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Errors and Bugs Report</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Errors and Bugs Report</span>
										</a>
									</li>
								</ul>
							</div>
						...
						<div class="m-portlet">
									...
									<div class="m-portlet__body">
										<ul class="nav nav-pills nav-fill" role="tablist">
											<li class="nav-item">
												<h5><a class="nav-link active" data-toggle="tab" href="#m_tabs_5_1">Errors and Bugs Report</a></h5>
											</li>	
										</ul>
										<div class="tab-content">
