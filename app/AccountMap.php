...
class AccountMap extends Model
{
    ...
    public function global_chart_of_accounts()
    {
        return $this->hasMany('App\GlobalChartOfAccount','account_map_no','id');
    }

    public function child_class()
    {
        return $this->hasMany('App\AccountMap','parent_id','id')->orderBy('map_no');
    }
